...
{
  rosapi_msgs__srv__NodeDetails_Request * msg = (rosapi_msgs__srv__NodeDetails_Request *)malloc(sizeof(rosapi_msgs__srv__NodeDetails_Request));
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__NodeDetails_Request__Sequence__init(rosapi_msgs__srv__NodeDetails_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__NodeDetails_Request *)calloc(size, sizeof(rosapi_msgs__srv__NodeDetails_Request));
    if (!data) {
      return false;
    }
...
{
  rosapi_msgs__srv__NodeDetails_Request__Sequence * array = (rosapi_msgs__srv__NodeDetails_Request__Sequence *)malloc(sizeof(rosapi_msgs__srv__NodeDetails_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosapi_msgs__srv__NodeDetails_Response * msg = (rosapi_msgs__srv__NodeDetails_Response *)malloc(sizeof(rosapi_msgs__srv__NodeDetails_Response));
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__NodeDetails_Response__Sequence__init(rosapi_msgs__srv__NodeDetails_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__NodeDetails_Response *)calloc(size, sizeof(rosapi_msgs__srv__NodeDetails_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosapi_msgs__srv__NodeDetails_Response__Sequence * array = (rosapi_msgs__srv__NodeDetails_Response__Sequence *)malloc(sizeof(rosapi_msgs__srv__NodeDetails_Response__Sequence));
  if (!array) {
    return NULL;
  }
