...
{
  rosapi_msgs__srv__GetParam_Request * msg = (rosapi_msgs__srv__GetParam_Request *)malloc(sizeof(rosapi_msgs__srv__GetParam_Request));
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__GetParam_Request__Sequence__init(rosapi_msgs__srv__GetParam_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__GetParam_Request *)calloc(size, sizeof(rosapi_msgs__srv__GetParam_Request));
    if (!data) {
      return false;
    }
...
{
  rosapi_msgs__srv__GetParam_Request__Sequence * array = (rosapi_msgs__srv__GetParam_Request__Sequence *)malloc(sizeof(rosapi_msgs__srv__GetParam_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosapi_msgs__srv__GetParam_Response * msg = (rosapi_msgs__srv__GetParam_Response *)malloc(sizeof(rosapi_msgs__srv__GetParam_Response));
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__GetParam_Response__Sequence__init(rosapi_msgs__srv__GetParam_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__GetParam_Response *)calloc(size, sizeof(rosapi_msgs__srv__GetParam_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosapi_msgs__srv__GetParam_Response__Sequence * array = (rosapi_msgs__srv__GetParam_Response__Sequence *)malloc(sizeof(rosapi_msgs__srv__GetParam_Response__Sequence));
  if (!array) {
    return NULL;
  }
