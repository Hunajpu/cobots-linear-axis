...
{
  rosapi_msgs__srv__ServiceNode_Request * msg = (rosapi_msgs__srv__ServiceNode_Request *)malloc(sizeof(rosapi_msgs__srv__ServiceNode_Request));
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__ServiceNode_Request__Sequence__init(rosapi_msgs__srv__ServiceNode_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__ServiceNode_Request *)calloc(size, sizeof(rosapi_msgs__srv__ServiceNode_Request));
    if (!data) {
      return false;
    }
...
{
  rosapi_msgs__srv__ServiceNode_Request__Sequence * array = (rosapi_msgs__srv__ServiceNode_Request__Sequence *)malloc(sizeof(rosapi_msgs__srv__ServiceNode_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosapi_msgs__srv__ServiceNode_Response * msg = (rosapi_msgs__srv__ServiceNode_Response *)malloc(sizeof(rosapi_msgs__srv__ServiceNode_Response));
  if (!msg) {
    return NULL;
  }
...
rosapi_msgs__srv__ServiceNode_Response__Sequence__init(rosapi_msgs__srv__ServiceNode_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosapi_msgs__srv__ServiceNode_Response *)calloc(size, sizeof(rosapi_msgs__srv__ServiceNode_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosapi_msgs__srv__ServiceNode_Response__Sequence * array = (rosapi_msgs__srv__ServiceNode_Response__Sequence *)malloc(sizeof(rosapi_msgs__srv__ServiceNode_Response__Sequence));
  if (!array) {
    return NULL;
  }
