...
static const _JointPosePanda_type_support_symbol_names_t _JointPosePanda_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_data, msg, JointPosePanda)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_data, msg, JointPosePanda)),
  }
};
...
{
  return &::ros2_data::msg::rosidl_typesupport_cpp::JointPosePanda_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_data, msg, JointPosePanda)() {
  return get_message_type_support_handle<ros2_data::msg::JointPosePanda>();
}
