...
{
  ros2_data__action__MoveJ_Goal * msg = (ros2_data__action__MoveJ_Goal *)malloc(sizeof(ros2_data__action__MoveJ_Goal));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_Goal__Sequence__init(ros2_data__action__MoveJ_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_Goal *)calloc(size, sizeof(ros2_data__action__MoveJ_Goal));
    if (!data) {
      return false;
    }
...
{
  ros2_data__action__MoveJ_Goal__Sequence * array = (ros2_data__action__MoveJ_Goal__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_Goal__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_Result * msg = (ros2_data__action__MoveJ_Result *)malloc(sizeof(ros2_data__action__MoveJ_Result));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_Result__Sequence__init(ros2_data__action__MoveJ_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_Result *)calloc(size, sizeof(ros2_data__action__MoveJ_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_Result__Sequence * array = (ros2_data__action__MoveJ_Result__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_Result__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_Feedback * msg = (ros2_data__action__MoveJ_Feedback *)malloc(sizeof(ros2_data__action__MoveJ_Feedback));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_Feedback__Sequence__init(ros2_data__action__MoveJ_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_Feedback *)calloc(size, sizeof(ros2_data__action__MoveJ_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_Feedback__Sequence * array = (ros2_data__action__MoveJ_Feedback__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_SendGoal_Request * msg = (ros2_data__action__MoveJ_SendGoal_Request *)malloc(sizeof(ros2_data__action__MoveJ_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_SendGoal_Request__Sequence__init(ros2_data__action__MoveJ_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_SendGoal_Request *)calloc(size, sizeof(ros2_data__action__MoveJ_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_SendGoal_Request__Sequence * array = (ros2_data__action__MoveJ_SendGoal_Request__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_SendGoal_Response * msg = (ros2_data__action__MoveJ_SendGoal_Response *)malloc(sizeof(ros2_data__action__MoveJ_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_SendGoal_Response__Sequence__init(ros2_data__action__MoveJ_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_SendGoal_Response *)calloc(size, sizeof(ros2_data__action__MoveJ_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_SendGoal_Response__Sequence * array = (ros2_data__action__MoveJ_SendGoal_Response__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_GetResult_Request * msg = (ros2_data__action__MoveJ_GetResult_Request *)malloc(sizeof(ros2_data__action__MoveJ_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_GetResult_Request__Sequence__init(ros2_data__action__MoveJ_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_GetResult_Request *)calloc(size, sizeof(ros2_data__action__MoveJ_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_GetResult_Request__Sequence * array = (ros2_data__action__MoveJ_GetResult_Request__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_GetResult_Response * msg = (ros2_data__action__MoveJ_GetResult_Response *)malloc(sizeof(ros2_data__action__MoveJ_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_GetResult_Response__Sequence__init(ros2_data__action__MoveJ_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_GetResult_Response *)calloc(size, sizeof(ros2_data__action__MoveJ_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_GetResult_Response__Sequence * array = (ros2_data__action__MoveJ_GetResult_Response__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ros2_data__action__MoveJ_FeedbackMessage * msg = (ros2_data__action__MoveJ_FeedbackMessage *)malloc(sizeof(ros2_data__action__MoveJ_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
ros2_data__action__MoveJ_FeedbackMessage__Sequence__init(ros2_data__action__MoveJ_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros2_data__action__MoveJ_FeedbackMessage *)calloc(size, sizeof(ros2_data__action__MoveJ_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ros2_data__action__MoveJ_FeedbackMessage__Sequence * array = (ros2_data__action__MoveJ_FeedbackMessage__Sequence *)malloc(sizeof(ros2_data__action__MoveJ_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
