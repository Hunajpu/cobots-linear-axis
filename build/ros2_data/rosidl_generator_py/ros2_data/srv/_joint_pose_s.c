...
bool ros2_data__srv__joint_pose__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_data.srv._joint_pose.JointPose_Request", full_classname_dest, 43) == 0);
  }
  ros2_data__srv__JointPose_Request * ros_message = _ros_message;
  {  // joint1
...
{
  /* NOTE(esteve): Call constructor of JointPose_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_data.srv._joint_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointPose_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool ros2_data__srv__joint_pose__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_data.srv._joint_pose.JointPose_Response", full_classname_dest, 44) == 0);
  }
  ros2_data__srv__JointPose_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of JointPose_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_data.srv._joint_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointPose_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
