...
class Metaclass_JointPosePanda(type):
    """Metaclass of message 'JointPosePanda'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_pose_panda
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_pose_panda
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_pose_panda
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_pose_panda
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_pose_panda
...
class JointPosePanda(metaclass=Metaclass_JointPosePanda):
    """Message class 'JointPosePanda'."""
