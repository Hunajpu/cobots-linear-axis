...
bool ros2_data__msg__joint_pose_panda__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_data.msg._joint_pose_panda.JointPosePanda", full_classname_dest, 46) == 0);
  }
  ros2_data__msg__JointPosePanda * ros_message = _ros_message;
  {  // joint1
...
{
  /* NOTE(esteve): Call constructor of JointPosePanda */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_data.msg._joint_pose_panda");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointPosePanda");
