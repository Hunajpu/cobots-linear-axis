...
{
  rosbridge_test_msgs__srv__TestRequestAndResponse_Request * msg = (rosbridge_test_msgs__srv__TestRequestAndResponse_Request *)malloc(sizeof(rosbridge_test_msgs__srv__TestRequestAndResponse_Request));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence__init(rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__srv__TestRequestAndResponse_Request *)calloc(size, sizeof(rosbridge_test_msgs__srv__TestRequestAndResponse_Request));
    if (!data) {
      return false;
    }
...
{
  rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence * array = (rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence *)malloc(sizeof(rosbridge_test_msgs__srv__TestRequestAndResponse_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__srv__TestRequestAndResponse_Response * msg = (rosbridge_test_msgs__srv__TestRequestAndResponse_Response *)malloc(sizeof(rosbridge_test_msgs__srv__TestRequestAndResponse_Response));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence__init(rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__srv__TestRequestAndResponse_Response *)calloc(size, sizeof(rosbridge_test_msgs__srv__TestRequestAndResponse_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence * array = (rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence *)malloc(sizeof(rosbridge_test_msgs__srv__TestRequestAndResponse_Response__Sequence));
  if (!array) {
    return NULL;
  }
